...
func Request(
	...
	rq, err := http.NewRequest(
		http.MethodPut,
		endpoint,
		getRequestBody(params.TakeProfit, params.StopLoss, httpClient),
	)
	if err != nil {
		return
	}
...
func getRequestBody(takeProfit *string, stopLoss *string, httpClient httpclient.Interface) io.Reader {
	body := ""
